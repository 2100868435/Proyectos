...
class GrafoVuelos
{
    ...
    public GrafoVuelos()
    {
        adyacencias = new Dictionary<string, List<Vuelo>>(StringComparer.OrdinalIgnoreCase); // Ignora mayúsculas/minúsculas
    }
...
class Program
{
    static void Main()
    {
        ...
        do
        {
            ...
            Console.WriteLine("Maria Ordoñez\n");
            ...
            switch (opcion)
            {
                case 1:
                    ...
                    {
                        Console.WriteLine("Origen y destino no pueden estar vacíos.");
                    ...
                    {
                        Console.WriteLine($"\nNo se encontraron vuelos desde {origen} a {destino}.");
                    }
                    else
                    {
                        ...
                        Console.WriteLine($"\n✈️ El vuelo más barato cuesta: ${encontrados.First().Precio}");
                    }
